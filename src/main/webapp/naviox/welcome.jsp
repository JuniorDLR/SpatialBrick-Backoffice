...
En SpatialBrick-labels_es.properties:
SpatialBrick=Tu aplicación
SpatialBrick[description]=Tu aplicación hace esto y lo otro

En SpatialBrick-messages_en.properties:
