...
```java
package ni.spatialBrick.SpatialBrick.modelo;
...
- Crea la clase de la acción en el paquete `ni.spatialBrick.SpatialBrick.acciones`, normalmente extendiendo `ViewBaseAction`
...
<controlador nombre="TuPrimeraEntidad">
    ...
    <accion nombre="mostrarImporte" modo="detail"
        clase="ni.spatialBrick.SpatialBrick.acciones.MostrarImporte"/>
</controlador>
```
...
- ✅ Coloca las clases de acción en `ni.spatialBrick.SpatialBrick.acciones`
...
```java
package ni.spatialBrick.SpatialBrick.pruebas;
...
- Crea un paquete `cuadrosmando` (ej. `ni.spatialBrick.SpatialBrick.cuadrosmando`) y coloca la clase `CuadroMando` y sus clases auxiliares en él.
